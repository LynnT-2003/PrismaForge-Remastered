  ...
  return (
    <div className="h-[100dvh] sm:h-[100vh] w-full overflow-y-hidden sm:py-12">
      ...
      <div className="w-full relative flex items-center justify-center h-[10%] ">
        <div className="flex w-full sm:w-[70%] items-center justify-between sm:bg-red-500 sm:py-2 rounded-xl sm:rounded-none sm:rounded-b-xl">
          {" "}
          <Button
            onClick={() => {
              router.push("/");
          ...
          >
            <div className="flex flex-col w-[3.5rem] items-center justify-center text-white sm:text-white">
          ...
          <div className="w-1/3 h-full flex items-center justify-center z-99">
            <Button
              ...
              className="p-[1.5rem] rounded-full aspect-square bg-red-100 border-red-300 border-[0.2rem] sm:border-[0.3rem] hover:bg-white"
              variant={"ghost"}
            ></Button>
          </div>
          <Button
            onClick={handleClick}
            variant={"ghost"}
            className="w-1/3 rounded-full hover:bg-[#181818] text-white sm:text-white"
          >
            <ImagePlusIcon
              size="2.5rem"
