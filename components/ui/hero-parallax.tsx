...
export const HeroParallax = ({
  ...
  return (
    <div>
      <div
        ref={ref}
        className="hidden md:flex w-screen h-[2600px] py-40 overflow-hidden antialiased relative flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
      >
        <Header />
        <motion.div
          style={{
